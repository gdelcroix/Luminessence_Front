      ...
      <Row className='d-flex flex-row gap-3 p-2'>
        <Col md={{ span: 8 }}>
          <Carousel indicators={false}>
            <Carousel.Item>
            <div className="d-flex align-items-center"><img className='d-block w-100' src='massage0.png' alt='First slide' />
              <Carousel.Caption>
            ...
            <Carousel.Item>
            <div className="d-flex align-items-center"><img className='d-block w-100' src='self hug.png' alt='Second slide' />
              <Carousel.Caption>
                <h3>First slide label</h3>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </Carousel.Caption></div>
            ...
            <Carousel.Item>
            <div className="d-flex align-items-center"><img className='d-block w-100' src='décoration_converted.avif' alt='Thrird slide' />
              <Carousel.Caption>
                <h3>First slide label</h3>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </Carousel.Caption></div>
