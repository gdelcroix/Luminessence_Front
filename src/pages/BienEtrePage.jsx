          ...
          <Col md={6} className='d-flex flex-column mx-auto justify-content-center align-items-center'>
            <Stack gap={2} className='w-100 mt-2 mx-auto'>
              ...
              <div className='d-flex bulle p-4 m-1 flex-row align-content-start'>
                <Col md={8}>
                  Réservez dès a présent votre séance atelier, seule ou entre ami/e/s !
                </Col>
                <Col>
        ...
        <Row className='d-flex flex-row gap-3 mx-5 justify-content-between'>
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Card.Text>
              Découvrez comment créer des baumes à lèvres hydratants avec des ingrédients naturels, simples et efficaces.
              </Card.Text>
          ...
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Card.Text>
              Apprenez à formuler des crèmes hydratantes maison adaptées à votre type de peau avec des ingrédients naturels.
              </Card.Text>
          ...
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Card.Text>
              Initiez-vous à la fabrication de gommages corporels exfoliants et naturels pour une peau douce et revitalisée.
              </Card.Text>
          ...
          <Card style={{ width: '18rem' }}>
            <Card.Body>
              ...
              <Card.Text>
              Maîtrisez l'art de concevoir des masques visage personnalisés pour un teint éclatant et une peau nourrie.
              </Card.Text>
